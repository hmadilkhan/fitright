        ...
        <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
            <center>
                <table cellspacing="0" cellpadding="0" width="600" class="w320">
                    <tr>
                        <td class="header-lg">
                            Welcome to <span style="text-transform: capitalize;">Fitrights
                        </td>
                    </tr>
                    <tr>
                        <td class="free-text">
                            <h3>Hello {!! $user->name.',' !!}</h3>
                            We are so happy you joined us! You have successfully signed up for a Fitrights account. You need to verify your email address and activate your account by clicking the button below.
                        </td>
                    </tr>
                    <tr>
                        <td class="button">
