        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="friend-box">
                    <figure>
                        <img src="{{asset('public/images/resources/frnd-cover1.jpg')}}" alt="">
                        <span>Followers: 120</span>
                    </figure>
                    <div class="frnd-meta">
                        <img src="{{asset('public/images/resources/frnd-figure1.jpg')}}" alt="">
                        <div class="frnd-name">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="friend-box">
                    <figure>
                        <img src="{{asset('public/images/resources/frnd-cover2.jpg')}}" alt="">
                        <span>Followers: 450</span>
                    </figure>
                    <div class="frnd-meta">
                        <img src="{{asset('public/images/resources/frnd-figure2.jpg')}}" alt="">
                        <div class="frnd-name">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="friend-box">
                    <figure>
                        <img src="{{asset('public/images/resources/frnd-cover3.jpg')}}" alt="">
                        <span>Followers: 50</span>
                    </figure>
                    <div class="frnd-meta">
                        <img src="{{asset('public/images/resources/frnd-figure3.jpg')}}" alt="">
                        <div class="frnd-name">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="friend-box">
                    <figure>
                        <img src="{{asset('public/images/resources/frnd-cover4.jpg')}}" alt="">
                        <span>Followers: 410</span>
                    </figure>
                    <div class="frnd-meta">
                        <img src="{{asset('public/images/resources/frnd-figure4.jpg')}}" alt="">
                        <div class="frnd-name">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="friend-box">
                    <figure>
                        <img src="{{asset('public/images/resources/frnd-cover5.jpg')}}" alt="">
                        <span>Followers: 16k</span>
                    </figure>
                    <div class="frnd-meta">
                        <img src="{{asset('public/images/resources/frnd-figure5.jpg')}}" alt="">
                        <div class="frnd-name">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="friend-box">
                    <figure>
                        <img src="{{asset('public/images/resources/frnd-cover6.jpg')}}" alt="">
                        <span>Followers: 2M</span>
                    </figure>
                    <div class="frnd-meta">
                        <img src="{{asset('public/images/resources/frnd-figure6.jpg')}}" alt="">
                        <div class="frnd-name">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="friend-box">
                    <figure>
                        <img src="{{asset('public/images/resources/frnd-cover7.jpg')}}" alt="">
                        <span>Followers: 220</span>
                    </figure>
                    <div class="frnd-meta">
                        <img src="{{asset('public/images/resources/frnd-figure7.jpg')}}" alt="">
                        <div class="frnd-name">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="friend-box">
                    <figure>
                        <img src="{{asset('public/images/resources/frnd-cover8.jpg')}}" alt="">
                        <span>Followers: 220</span>
                    </figure>
                    <div class="frnd-meta">
                        <img src="{{asset('public/images/resources/frnd-figure8.jpg')}}'" alt="">
                        <div class="frnd-name">
