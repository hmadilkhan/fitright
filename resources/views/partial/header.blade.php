                ...
                <div class="dropdowns">
                    ...
                    <ul class="drops-menu">
                        <li>
                            <div>
                                <figure>
                                    <img src="{{asset('public/images/resources/thumb-2.jpg')}}" alt="">
                                </figure>
                                <div class="mesg-meta">
                        ...
                        <li>
                            <div>
                                <figure>
                                    <img src="{{asset('public/images/resources/thumb-3.jpg')}}" alt="">
                                </figure>
                                <div class="mesg-meta">
                        ...
                        <li>
                            <div>
                                <figure>
                                    <img src="{{asset('public/images/resources/thumb-4.jpg')}}" alt="">
                                </figure>
                                <div class="mesg-meta">
                        ...
                        <li>
                            <div>
                                <figure>
                                    <img src="{{asset('public/images/resources/thumb-5.jpg')}}" alt="">
                                </figure>
                                <div class="mesg-meta">
                        ...
                        <li>
                            <div>
                                <figure>
                                    <img src="{{asset('public/images/resources/thumb-1.jpg')}}" alt="">
                                </figure>
                                <div class="mesg-meta">
                            ...
                            <a href="notifications.html" title="">
                                ...
                                <div class="mesg-meta">
                                    ...
                                    <figure>
                                        ...
                                        <img src="{{asset('public/images/birthday.png')}}" alt="">
                                    </figure>
                                </div>
                            </a>
                        </li>
                ...
                <div class="dropdowns">
                    ...
                    <ul class="drops-menu">
                        ...
                        <li>
                            <a class="show-mesg" href="#" title="">
                                <figure>
                                    <img src="{{asset('public/omages/resources/thumb-4.jpg')}}" alt="">
                                    <span class="status f-offline"></span>
                                </figure>
                                <div class="mesg-meta">
                                    <h6>Tom cruse</h6>
                    ...
                    <div data-gutter="10" class="row">
                        <div class="col-md-3">
                            <ul class="dropdown-meganav-select-list-lang">
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/UK.png')}}">English(UK)
                                    </a>
                                </li>
                                <li class="active">
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/US.png')}}">English(US)
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/DE.png')}}">Deutsch
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/NED.png')}}">Nederlands
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/FR.png')}}">Français
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/SP.png')}}">Español
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/ARG.png')}}">Español (AR)
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/IT.png')}}">Italiano
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/PT.png')}}">Português (PT)
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/BR.png')}}">Português (BR)
                                    </a>
                                </li>
                        ...
                        <div class="col-md-3">
                            <ul class="dropdown-meganav-select-list-lang">
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/FIN.png')}}">Suomi
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/SW.png')}}">Svenska
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/DEN.png')}}">Dansk
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/CZ.png')}}">Čeština
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/HUN.png')}}">Magyar
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/ROM.png')}}">Română
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/JP.png')}}">日本語
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/CN.png')}}">简体中文
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/PL.png')}}">Polski
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/GR.png')}}">Ελληνικά
                                    </a>
                                </li>
                        ...
                        <div class="col-md-3">
                            <ul class="dropdown-meganav-select-list-lang">
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/TUR.png')}}">Türkçe
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/BUL.png')}}">Български
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/ARB.png')}}">العربية
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/KOR.png')}}">한국어
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/ISR.png')}}">עברית
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/LAT.png')}}">Latviski
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/UKR.png')}}">Українська
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/IND.png')}}">Bahasa Indonesia
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/MAL.png')}}">Bahasa Malaysia
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/TAI.png')}}">ภาษาไทย
                                    </a>
                                </li>
                        ...
                        <div class="col-md-3">
                            <ul class="dropdown-meganav-select-list-lang">
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/CRO.png')}}">Hrvatski
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/LIT.png')}}">Lietuvių
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/SLO.png')}}">Slovenčina
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/SERB.png')}}">Srpski
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/SLOVE.png')}}">Slovenščina
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/NAM.png')}}">Tiếng Việt
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/PHI.png')}}">Filipino
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/ICE.png')}}">Íslenska
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/EST.png')}}">Eesti
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img title="Image Title" alt="Image Alternative text" src="{{asset('public/images/flags/RU.png')}}">Русский
                                    </a>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="user-img">
            ...
            <div class="user-setting">
                ...
                <ul class="log-out">
                    ...
                    <li><a href="{{auth()->logout()}}" title=""><i class="ti-power-off"></i>log out</a></li>
                </ul>
            </div>
        </div>
